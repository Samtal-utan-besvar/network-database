...
const createWebsocket = require('./testHelpers.js').createWebsocket;
const waitForSocketConnection = require('./testHelpers.js').waitForSocketConnection;
...
chai.use(chaiHttp);
process.env.ENV_VERBOSE = false;
console.log(process.env.ENV_VERBOSE);
...
var wsClientA;
var wsClientAToken;
const wsClientAEmail = (Math.random() + 1).toString(36).substring(10) + "@domain.test";
const wsClientAPhoneNumber = Math.round(Math.random() * (8999999999) + 1000000000).toString();
var wsClientB;
var wsClientBToken;
const wsClientBEmail = (Math.random() + 1).toString(36).substring(10) + "@domain.test";
...
describe('Clean Full Test', () => {
    ...
    it('Establish Client Connection - Client A', (done) => {
        ...
        waitForSocketConnection(wsClientA, function () {
    ...
    it('Establish Client Connection - Client B', (done) => {
        ...
        waitForSocketConnection(wsClientB, function () {
